		...
		<div class="tab-content">
			<div class="tab-pane box active">
				<div class="mb-md clearfix">
					<div class="export_title pull-left"><?php echo translate('employee') . " " . translate('list'); ?></div>
					<?php if (get_permission('employee', 'is_edit')): ?>
						<div class="pull-right">
							<a href="<?php echo base_url('employee/bulk_disable_accounts'); ?>" class="btn btn-warning btn-sm">
								<i class="fas fa-ban"></i> <?php echo translate('bulk_disable_accounts'); ?>
							</a>
						</div>
					<?php endif; ?>
				</div>
