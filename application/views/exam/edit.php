		...
		<div class="tab-content">
			<div class="tab-pane active" id="create">
				...
				<div class="form-horizontal form-bordered mb-lg">
					...
					<div class="form-group">
						<label class="col-md-3 control-label"><?= translate('fee_payment_threshold') ?> (%)</label>
						<div class="col-md-6">
							<input type="number" class="form-control" name="fee_threshold_percentage" value="<?= isset($exam['fee_threshold_percentage']) ? $exam['fee_threshold_percentage'] : 0 ?>" min="0" max="100" step="0.01" />
							<span class="help-block"><i class="fas fa-info-circle"></i> <?= translate('set_minimum_fee_percentage_to_view_results') ?> (0 = <?= translate('no_restriction') ?>)</span>
							<span class="error"></span>
						</div>
					</div>
					<div class="form-group">
