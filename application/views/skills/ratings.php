<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#list" data-toggle="tab"><i class="fas fa-list-ul"></i> <?=translate('skills_ratings')?></a>
			</li>
<?php if (get_permission('skills_ratings', 'is_add')): ?>
			<li>
				<a href="#create" data-toggle="tab"><i class="far fa-edit"></i> <?=translate('add_rating')?></a>
			</li>
<?php endif; ?>
		</ul>
		<div class="tab-content">
			<div id="list" class="tab-pane active">
				...
				<?php endif; ?>
				<div class="mb-md">
					<p class="text-muted"><i class="fas fa-info-circle"></i> Define the rating scale used for evaluating student skills (e.g., A, B, C or Excellent, Good, Fair)</p>
				</div>
				<table class="table table-bordered table-hover mb-none table-export">
					...
					<tbody>
						<?php $count = 1; foreach($ratings as $row): ?>
						<tr>
						...
						<?php endif; ?>
							...
							<td><?php echo $row['numeric_value']; ?></td>
							...
							<td class="action">
							<?php if (get_permission('skills_ratings', 'is_edit')): ?>
								<!-- edit link -->
								<a href="<?php echo base_url('skills/edit_rating/' . $row['id']);?>" class="btn btn-default btn-circle icon">
									<i class="fas fa-pen-nib"></i>
								</a>
							<?php endif; if (get_permission('skills_ratings', 'is_delete')): ?>
								<!-- delete link -->
								<?php echo btn_delete('skills/delete_rating/' . $row['id']);?>
							<?php endif; ?>
							</td>
						</tr>
						<?php endforeach;?>
...
<?php if (get_permission('skills_ratings', 'is_add')): ?>
			<div class="tab-pane" id="create">
				<?php echo form_open($this->uri->uri_string(), array('class' => 'frm-submit'));?>
					...
					<?php endif; ?>
						<div class="form-group">
							<label class="col-md-3 control-label"><?=translate('label')?> <span class="required">*</span></label>
							<div class="col-md-6">
								<input type="text" class="form-control" name="label" value="" autocomplete="off"
									placeholder="e.g., A, B, C, D, E or Excellent, Good, Fair" maxlength="10" />
								<span class="error"></span>
								<span class="help-block"><small>Short rating label (max 10 characters)</small></span>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 control-label"><?=translate('numeric_value')?> <span class="required">*</span></label>
							<div class="col-md-6">
								<input type="number" class="form-control" name="numeric_value" value="" min="1" max="10"
									placeholder="e.g., 5 for Excellent, 1 for Poor" />
								<span class="error"></span>
								<span class="help-block"><small>Higher numbers = better performance</small></span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" name="description" value=""
									placeholder="e.g., Excellent, Outstanding, Needs Improvement" maxlength="100" />
								<span class="error"></span>
							</div>
						</div>
						<div class="form-group">
