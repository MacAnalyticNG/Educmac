                        ...
                        <li class="nav-parent <?php if ($main_menu == 'student') echo 'nav-expanded nav-active'; ?>">
                            ...
                            <ul class="nav nav-children">
                                ...
                                if (get_permission('student', 'is_edit')) { ?>
                                    <li class="<?php if ($sub_page == 'student/bulk_disable_accounts') echo 'nav-active'; ?>">
                                        <a href="<?= base_url('student/bulk_disable_accounts') ?>">
                                            <span><i class="fas fa-caret-right" aria-hidden="true"></i><?= translate('bulk_disable_accounts') ?></span>
                                        </a>
                                    </li>
                                <?php }
                        ...
                        <li class="nav-parent <?php if ($main_menu == 'parents') echo 'nav-expanded nav-active'; ?>">
                            ...
                            <ul class="nav nav-children">
                                ...
                                if (get_permission('parent', 'is_edit')) { ?>
                                    <li class="<?php if ($sub_page == 'parents/bulk_disable_accounts') echo 'nav-active'; ?>">
                                        <a href="<?= base_url('parents/bulk_disable_accounts') ?>">
                                            <span><i class="fas fa-caret-right" aria-hidden="true"></i><?= translate('bulk_disable_accounts') ?></span>
                                        </a>
                                    </li>
                                <?php }
                        ...
                        <li class="nav-parent <?php if ($main_menu == 'employee') echo 'nav-expanded nav-active'; ?>">
                            ...
                            <ul class="nav nav-children">
                                ...
                                if (get_permission('employee', 'is_edit')) { ?>
                                    <li class="<?php if ($sub_page == 'employee/bulk_disable_accounts') echo 'nav-active'; ?>">
                                        <a href="<?php echo base_url('employee/bulk_disable_accounts'); ?>">
                                            <span><i class="fas fa-caret-right" aria-hidden="true"></i><?php echo translate('bulk_disable_accounts'); ?></span>
                                        </a>
                                    </li>
                                <?php }
                    ...
                    ?>
                        ...
                        <li class="nav-parent <?php if ($main_menu == 'exam' || $main_menu == 'mark' || $main_menu == 'exam_timetable' || $main_menu == 'marksheet_template') echo 'nav-expanded nav-active'; ?>">
                            ...
                            <ul class="nav nav-children">
                                ...
                                // Skills Module Menu
                                if (
                                    get_permission('skills_categories', 'is_view') ||
                                    get_permission('skills_items', 'is_view') ||
                                    get_permission('skills_ratings', 'is_view') ||
                                    get_permission('skills_rating_entry', 'is_view')
                                ) {
                                ?>
                                    <!-- Skills Module -->
                                    <li class="nav-parent <?php if ($sub_menu == 'skills/categories' || $sub_menu == 'skills/items' || $sub_menu == 'skills/ratings' || $sub_menu == 'skills/rating_entry') echo 'nav-expanded nav-active'; ?>">
                                        <a>
                                            <i class="fas fa-star"></i> <span><?= translate('skills_assessment') ?></span>
                                        </a>
                                        <ul class="nav nav-children">
                                            <?php if (get_permission('skills_categories', 'is_view')) { ?>
                                                <li class="<?php if ($sub_menu == 'skills/categories') echo 'nav-active'; ?>">
                                                    <a href="<?= base_url('skills/categories') ?>">
                                                        <span><?= translate('skills_categories') ?></span>
                                                    </a>
                                                </li>
                                            <?php }
                                            if (get_permission('skills_items', 'is_view')) { ?>
                                                <li class="<?php if ($sub_menu == 'skills/items') echo 'nav-active'; ?>">
                                                    <a href="<?= base_url('skills/items') ?>">
                                                        <span><?= translate('skills_items') ?></span>
                                                    </a>
                                                </li>
                                            <?php }
                                            if (get_permission('skills_ratings', 'is_view')) { ?>
                                                <li class="<?php if ($sub_menu == 'skills/ratings') echo 'nav-active'; ?>">
                                                    <a href="<?= base_url('skills/ratings') ?>">
                                                        <span><?= translate('rating_scale') ?></span>
                                                    </a>
                                                </li>
                                            <?php }
                                            if (get_permission('skills_rating_entry', 'is_view')) { ?>
                                                <li class="<?php if ($sub_menu == 'skills/rating_entry') echo 'nav-active'; ?>">
                                                    <a href="<?= base_url('skills/rating_entry') ?>">
                                                        <span><?= translate('rating_entry') ?></span>
                                                    </a>
                                                </li>
                                            <?php } ?>
                                        </ul>
                                    ...
                                    <li class="nav-parent <?php if ($main_menu == 'exam_reports') echo 'nav-expanded nav-active'; ?>">
                                        ...
                                        <ul class="nav nav-children">
                                            ...
                                            if (get_permission('tabulation_sheet', 'is_view')) { ?>
                                                ...
                                                <li class="<?php if ($sub_page == 'skills/tabulation_sheet') echo 'nav-active'; ?>">
                                                    <a href="<?= base_url('skills/tabulation_sheet') ?>">
                                                        <span><?= translate('junior_tabulation_sheet') ?></span>
                                                    </a>
                                                </li>
                                            <?php }
                                            if (get_permission('progress_reports', 'is_view')) { ?>
                                                ...
                                                <li class="<?php if ($sub_page == 'exam_progress/marksheet_junior') echo 'nav-active'; ?>">
                                                    <a href="<?= base_url('exam_progress/marksheet_junior') ?>">
                                                        <span><?= translate('junior') . " " . translate('progress') . " " . translate('reports') ?></span>
                                                    </a>
                                                </li>
                                            <?php } ?>
                                        </ul>
                    ...
                    ?>
                        ...
                        <li class="nav-parent <?php if ($main_menu == 'settings' || $main_menu == 'school_m') echo 'nav-expanded nav-active'; ?>">
                            ...
                            <ul class="nav nav-children">
                                ...
                                <?php }
                                if (is_superadmin_loggedin()) { ?>
                                    <li class="<?php if ($sub_page == 'migration_runner/index' || $sub_page == 'migration_runner/status' || $sub_page == 'migration_runner/result') echo 'nav-active'; ?>">
                                        <a href="<?= base_url('migration_runner') ?>">
                                            <span><i class="fas fa-caret-right" aria-hidden="true"></i><?= translate('database_migrations') ?></span>
                                        </a>
                                    </li>
                                <?php }
