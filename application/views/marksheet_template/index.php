					...
					<div class="form-group">
						<div class="col-md-offset-3 col-md-8">
							...
							<div class="checkbox-replace mt-sm mb-lg">
								<label class="i-checks">
									<input type="checkbox" name="subjects_table" value="true"><i></i> <?php echo translate('subjects') . " " . translate('table'); ?> (For Skills Report Card)
								</label>
							</div>
							<div class="checkbox-replace mt-sm mb-lg">
								<label class="i-checks">
									<input type="checkbox" name="show_skills" value="true"><i></i> <?php echo translate('skills'); ?> (Skills Assessment Section)
								</label>
							</div>
						</div>
					</div>
